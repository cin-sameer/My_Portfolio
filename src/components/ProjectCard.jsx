...
export default function ProjectCard({project}) {
    return(
        <div className="project-card">
            ...
            <div className="project-body">
               ...
               {/* <button className="bookmarkBtn" onClick={() => window.open(project.demo, "_blank")}>
  <span className="IconContainer">
    <svg viewBox="0 0 24 24" height="0.9em" className="icon" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
  ...
  <p className="text">Demo</p>
                     ...
                     <button className="botton-github" onClick={() => window.open(project.github, "_blank")}>
